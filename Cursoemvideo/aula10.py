''''fru = input('Qual sua fruta preferida?').strip()
if fru.lower() == 'laranja':
    print('Excelente escolha!')
else:
    print('Arghh...')
import random
lista = ['Mago' , 'Caçador' , 'Bruxo' , 'Xamã' , 'Sacerdote' , 'Druida' , 'Caçador de demônios' , 'Guerreiro' , 'Paladino']
al = (random.choice(lista))
if al == 'Mago':
    print('Caiu mago!!')
else:
    print(f'Droga... caiu {al}')'''
